...
2. Частная производная Q по $\theta_j$ (Производная квадрата):
...
# Матричная форма градиента по всему вектору $\theta$
...
Пусть к каждому объекту $x_i$ добавим фиктивный признак $x_{i,0}=1$. Получим расширенный вектор   

$$
\tilde{x}_i = (1, x_{i1}, \dots, x_{id})^\top
$$
...
# 3. Сравнение полного градиентного спуска и стохастического (SGD)
